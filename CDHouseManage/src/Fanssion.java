...
public class Fanssion {
    ...
    ArrayList<CD> listCD = new ArrayList<>(700);
    ...
    public void addCD() {
        if (listCD.size() > 700) {
            System.out.println("full storage, please update to prenium to get more space.");
        } else {
            do { // CD name here 
                //check empty, blank
            ...
            do { // publising year here
                try {
                    System.out.println("(are you a human? if you are, please put the year greater 1980)"
...
//                FileReader fr = new FileReader("CDStorage.txt"); //buffered reader 
